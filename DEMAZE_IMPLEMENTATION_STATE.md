...
|---|---|---|---|
| 1 | `Hero` | Hero | ✅ Done — Real H1, subcopy, CTAs, Krupal Chaudhary Testimonial; P1.5 sphere stage refinement complete (commit `fcd9279`): legacy telemetry purged from HTML & JS, frosted glass browser card with blur(24px) against daytime sky atmosphere, Three.js camera distance scaled to z=1.95 (sphere fills ~73% of stage), Framer appear transforms neutralized (`transform:none!important`) preventing background shift and text collisions, verified across all 5 viewports (1440, 1280, 1024, 768, 375). |
