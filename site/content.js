...
module.exports = {
  ...
  founder: {
    ...
    title: 'Founder & CEO',
    photo: img('e57nypBBfPrAXfYYyYgNJBgJBo.jpeg', 600),
  ...
  projects: [
    { title: 'AI-Based software for luxury car dealers', image: img('bVi4OWXFwyZEQNbjP5qntMAjM.png'), tint: '#dfe6ff',
    ...
    { title: 'Investigative Case Management Software', image: img('jHPfuoOX9UNd8Es5s5F3M8wzzo.png'), tint: '#e9e2ff',
    ...
    { title: 'AI-Powered luxury eCommerce Platform', image: img('BCoc1XvtfjF8KIgSc4BmvU1WH8U.png'), tint: '#dcf3e6',
    ...
    { title: 'Senior Engagement & Support platform', image: img('VsL7mX1NiP3eW5xTBH6fPjjVFfw.png'), tint: '#fff1cf',
    ...
    { title: 'Multi-vendor eCommerce Marketplace', image: img('n2k5j6C5nfmufhjsYnF8HXy5qY.png'), tint: '#ffe0e6',
    ...
    { title: 'Multi-shoppers Food & Grocery Delivery App', image: img('kl6BbE7vPzKmqIbeDQ2Qi0qBgrw.png'), tint: '#e2f6d5',
    ...
    { title: 'Car service & customer engagement platform', image: img('LkWna9MnJ0LQbLJbzCItYR1WToQ.png'), tint: '#dfe6ff',
    ...
    { title: 'B2B Gift Marketplace', image: img('NxeTM3QYjqofdnrCxBKAHh3DsM.png'), tint: '#ffe8d6',
    ...
    { title: 'Global Payment transfer platform', image: img('kyC8zhxd43towb5gNsnL6f6dFv8.png'), tint: '#e9e2ff',
    ...
    { title: 'CMA Report Generation Software', image: img('xnzi7jiqfDDlLZolcWcHXwwAwM.png'), tint: '#dcf3e6',
    ...
    { title: 'Recruitment platform', image: img('rUzLQ1C7Zx5YbVPxiCc2j76p2nA.png'), tint: '#fff1cf',
    ...
    { title: 'Task, Staff & Document management platform', image: img('7tURVBvnRlwhQdd3SABZp9NRAQ.png'), tint: '#ffe0e6',
    ...
    // Live site reuses the B2B Gift description here (copy-paste error) — omitted until real copy exists.
    { title: 'Educational courses & LMS platform', image: img('BXHb6zyrRU44ZupahdRjnPEGNY.png'), tint: '#e2f6d5', description: '',
    ...
    { title: 'Storyboard creation for films with AI', image: img('No26KTnaY7sTJQew3bCYMTEA9Y.png'), tint: '#e9e2ff',
    ...
    // Live site lists "Seamless Car Refurbishment" here (copy-paste error) — dropped.
    { title: 'Insurance management platform', image: img('nNBWJKmVpqgS1Y24ytr2NoBlkrU.png'), tint: '#dfe6ff',
    ...
    { title: 'Social media & social commerce platform', image: img('9ErLyzgwIn6SCVsXdSIzFSVM7IY.png'), tint: '#ffe8d6',
  ...
  // Homepage engineering stack (grouped list + orbit), carried over from the previous site build.
  // Logos are the icons Demaze uses on demazetech.com.
  stack: {
    ...
    items: [
      { name: 'OpenAI', role: 'Large Language Models', group: 'AI Models', orbit: 0, icon: 'XkdawulL9cthX7AFF1LI4bXv0o.png' },
      { name: 'Hugging Face', role: 'Open-Source AI Models', group: 'AI Models', orbit: 1, icon: 'MtA8cVDkuxvUGdyeyvSKiGb7qA.png' },
      { name: 'LangChain', role: 'LLM Orchestration', group: 'Orchestration', orbit: 0, icon: '6yzPxfL2zbqicuK8rRc9eMVRIkM.png' },
      { name: 'Python', role: 'Core AI & APIs', group: 'Orchestration', orbit: 0, icon: 'm9s52nA5urnyuoWxNt414Ghwo.png' },
      { name: 'TensorFlow', role: 'Machine Learning Models', group: 'Data & ML', orbit: 0, icon: 'ZDKJY420KwTFElm5cbE51nd1uI.png' },
      { name: 'Pinecone Database', role: 'Vector Database', group: 'Data & ML', orbit: 1, icon: 'nlfwFe7bR5JQliZS9i8AghDDzBg.png' },
      { name: 'Apache Kafka', role: 'Real-Time Streaming', group: 'Streaming & Search', orbit: 1, icon: 'E38BAlxLDaA0pVazXApaqDRmLA.png' },
      { name: 'Elasticsearch', role: 'Search & Indexing', group: 'Streaming & Search', orbit: 1, icon: 'CEWChIc50KX3RlDIkbgZZdxje4M.png' },
    ],
  },
  ...
  tools: [
    ...
    { tab: 'UI/UX', items: [['Figma', 'figma'], ['Adobe XD', null], ['Photoshop', null], ['Illustrator', null], ['Sketch', 'sketch'], ['InVision', null], ['Marvel', null], ['Zeplin', null], ['Balsamiq', null], ['Axure RP', null]] },
    { tab: 'eCommerce', items: [['React.js', 'react'], ['Next.js', 'nextdotjs'], ['Node.js', 'nodedotjs'], ['Nest.js', 'nestjs'], ['Express.js', 'express'], ['MongoDB', 'mongodb'], ['PostgreSQL', 'postgresql'], ['MySQL', 'mysql'], ['Redis', 'redis'], ['Elastic Search', 'elasticsearch'], ['AWS', null], ['GCP', 'googlecloud'], ['Heroku', null], ['Azure', null], ['Hostinger', 'hostinger']] },
    { tab: 'Cloud', items: [['AWS', null], ['GCP', 'googlecloud'], ['Azure', null], ['Docker', 'docker'], ['Kubernetes', 'kubernetes'], ['Terraform', 'terraform'], ['Jenkins', 'jenkins'], ['Github', 'github'], ['Postman', 'postman'], ['JMeter', 'apachejmeter'], ['Selenium', 'selenium'], ['Vultr', 'vultr'], ['Digital Ocean', 'digitalocean'], ['Heroku', null], ['Apache Kafka', 'apachekafka'], ['Redis', 'redis'], ['Elastic Search', 'elasticsearch']] },
  ],
